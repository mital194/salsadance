...
function About(){
    return(
        <div> 
            ...
            Established in 2005, Saskatoon Salsa proudly offers lessons for every demographic from six years old and up including classes for individuals, couples classes, and even a ladies-only Salsa class. And if your goal is performance, you can look forward to learning other Cuban dance favourites like Mambo, Cha-Cha-Cha, Rumba, and more! In addition to their core programming of Cuban dance, Saskatoon Salsa also offers the globe-trotting dance lessons of Bachata, Rueda de Casino, Bollywood, and Kizomba.

            Led by Kimberly Parent and her team of experienced and personable instructors, every class at Saskatoon Salsa features both instruction and actual dancing to music so you learn in the most hands-on (and most fun) way. No matter if you’re six or seventy, if you want to get up on stage or just get a little exercise with a smile on your face, Saskatoon Salsa is excited to be your destination for dance.
            </p>
        </div>
    )
}
